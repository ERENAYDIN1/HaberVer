  ...
  return (
    <>
      <defs>
        ...
        >
          <stop offset="0.552885" stopColor="#865B50" />
      ...
      />
      <path
        d="M51.7347 138.703C51.7347 138.703 53.4879 138.602 54.2104 138.395C54.9329 138.187 55.9104 137.571 55.9104 137.571C55.9104 137.571 62.6838 144.658 63.3851 145.253C64.0704 145.832 64.8779 137.003 64.8779 137.003C64.8779 137.003 66.4238 137.242 67.8688 137.013C69.7707 136.711 71.0669 136.105 71.0669 136.105C71.0669 136.105 70.1426 141.54 69.7813 143.601C69.5529 144.924 69.4732 148.6 69.4732 148.6L64.5219 152.722L60.7554 150.194C60.7554 150.194 60.7447 149.2 60.1869 148.526C58.4551 146.432 51.7347 138.703 51.7347 138.703ZM69.0057 150.821L72.7722 146.284C72.7722 146.284 74.111 146.385 75.0938 146.385C76.0713 146.385 77.7766 146.177 77.7766 146.177C77.7766 146.177 74.6847 150.353 73.0326 152.414C71.3804 154.476 69.2182 157.057 69.2182 157.057L67.1569 151.076L69.0057 150.821Z"
        fill="#6D4B41"
      />
      <path
        d="M66.3281 147.208C64.7875 147.346 60.7606 150.199 60.7606 150.199C60.7606 150.199 60.9678 155.044 60.8137 157.78C60.6597 160.516 59.5066 165.868 60.5 167C61.3606 167.978 68.9216 168.137 70 167C71.0838 165.863 69.7812 160.309 69.7812 157.265C69.7812 154.221 69.4731 148.6 69.4731 148.6C69.4731 148.6 68.0812 147.054 66.3281 147.208Z"
        fill="#865B50"
      />
      <path
        d="M60.15 166C60.0927 165.506 70.3946 165.73 70.3735 166C70.3485 166.319 70.1693 166.892 70 167H60.5C60.2969 166.708 60.2073 166.494 60.15 166Z"
      ...
      />
      <path
        d="M153.467 26C164.698 27.9804 174.682 34.3411 181.224 43.683C187.765 53.0249 190.327 64.5826 188.347 75.8137"
        fill="none"
        stroke="#8DC63F"
        strokeWidth="7"
        strokeLinecap="round"
    ...
    <svg viewBox="0 0 64 64" fill="none" className={className}>
      <g transform={AMBLEM_DONUSUMU} fill="currentColor">
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M96 221C96 221 176 155 176 113C176 91.7827 167.571 71.4344 152.569 56.4315C137.566 41.4285 117.217 33 96 33C74.7827 33 54.4344 41.4285 39.4315 56.4315C24.4285 71.4344 16 91.7827 16 113C16 155 96 221 96 221ZM117 82.0232V167.977C117 168.542 116.568 169 116.034 169H89.9655C89.4323 169 89 168.542 89 167.977V88.4999L117 82.0232ZM146 109.5V168.245C146 168.798 145.471 169.245 144.818 169.245H121.182C120.529 169.245 120 168.798 120 168.245V101.5L146 109.5Z"
        />
        <path d="M48.0001 114.101C48.0001 114.101 49.291 110.223 52.3351 107.789C55.3791 105.356 83.5991 115.779 83.5991 115.779C83.5991 115.779 88.5291 117.538 91.4457 122.197C93.406 125.331 94.5004 129.964 92.4232 135.558C87.4719 148.882 74.6263 147.341 71.2794 146.581C69.7069 146.225 65.8766 145.211 65.8766 145.211C65.8766 145.211 57.1269 152.436 46.5976 146.895C38.581 142.677 39.5744 136.371 39.5744 136.371C39.5744 136.371 34.1769 130.973 36.5144 123.456C39.3301 114.403 48.0001 114.101 48.0001 114.101Z" />
        <path d="M66.3281 147.208C64.7875 147.346 60.7606 150.199 60.7606 150.199C60.7606 150.199 60.9678 155.044 60.8137 157.78C60.6597 160.516 59.5066 165.868 60.5 167C61.3606 167.978 68.9216 168.137 70 167C71.0838 165.863 69.7812 160.309 69.7812 157.265C69.7812 154.221 69.4731 148.6 69.4731 148.6C69.4731 148.6 68.0812 147.054 66.3281 147.208Z" />
      </g>
      <g
        ...
        strokeLinecap="round"
      >
        <path d="M151.209 38.8025C159.045 40.1841 166.011 44.6219 170.575 51.1394C175.138 57.657 176.926 65.7206 175.544 73.5562" />
        <path d="M153.467 26C164.698 27.9804 174.682 34.3411 181.224 43.683C187.765 53.0249 190.327 64.5826 188.347 75.8137" />
      </g>
    </svg>
  );
}
